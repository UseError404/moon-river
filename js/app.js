(() => {
    ...
    function ActivationMenu() {
        document.querySelector(".header__logo-white").classList.toggle("header__logo-picture-active");
        document.querySelector(".header__logo-dark").classList.toggle("header__logo-picture-active");
        document.querySelector(".zero").classList.toggle("zero-active");
        document.querySelector(".menu__body").classList.toggle("menu__body-visibility");
        document.querySelector(".header__icons-panel").classList.toggle("header__icons-panel-visibility");
    }
    ...
    function initSliders() {
        if (document.querySelector(".slider__swiper")) new swiper_core_Swiper(".slider__swiper", {
...
*/
    ...
    function openMenuWithActiveTab() {
        const elementKillAnima = document.querySelectorAll(".tabs, .tabs__title, .tabs__title-menu, .tabs__item");
        gsapWithCSS.killTweensOf(elementKillAnima);
        gsapWithCSS.set(".tabs", {
            opacity: 0,
            xPercent: -100
        });
        gsapWithCSS.set(".tabs__title", {
            opacity: 0
        });
        gsapWithCSS.set(".tabs__title-menu, .tabs__item", {
            opacity: 0,
            y: -10
        });
        const tabsBodies = document.querySelectorAll(".tabs__body");
        ...
        timeline.to(".tabs", {
            ...
            stagger: .1,
            ease: "power2"
        }, "-=.2").to(".tabs__body.active .tabs__title-menu", {
            opacity: 1,
            y: 0,
            stagger: .15,
            duration: .6,
            ease: "power2"
        }, "-=.3").to(".tabs__body.active .tabs__item", {
            opacity: 1,
            y: 0,
            stagger: .08,
            duration: .8,
    ...
    function switchTab(index) {
        ...
        tabsBodies.forEach(tab => {
            ...
            gsapWithCSS.killTweensOf(elements);
        ...
        const timeline = gsapWithCSS.timeline();
        timeline.to(activeTab.querySelectorAll(".tabs__title-menu"), {
            opacity: 1,
            y: 0,
            stagger: .15,
            duration: .5,
    ...
    function scrollAnimation() {
        gsapWithCSS.from(".sectionMF__men", {
            scrollTrigger: {
                trigger: ".sectionMF",
                start: "-200 100"
            },
        ...
        gsapWithCSS.from(".sectionMF__women", {
            scrollTrigger: {
                trigger: ".sectionMF",
                start: "-200 100"
            },
        ...
        gsapWithCSS.from(".proposals__grid-items", {
            scrollTrigger: {
                trigger: ".proposals",
                start: "-200 200"
            },
        ...
        gsapWithCSS.from(".slider__slide", {
            scrollTrigger: {
                trigger: ".slider",
                start: "100 200"
            },
        ...
        gsapWithCSS.from(".slider__title", {
            scrollTrigger: {
                trigger: ".slider",
                start: "100 200"
            },
        ...
        gsapWithCSS.from(".slider__social-link img", {
            scrollTrigger: {
                trigger: ".slider",
                start: "100 200"
            },
        ...
        gsapWithCSS.from(".footer__picture img", {
            scrollTrigger: {
                trigger: ".footer",
                start: "-100 center"
            },
        ...
        gsapWithCSS.from(".footer__text-banner", {
            scrollTrigger: {
                trigger: ".footer",
                start: "-100 center"
            },
        ...
        gsapWithCSS.from(".footer__title-banner", {
            scrollTrigger: {
                trigger: ".footer",
                start: "-100 center"
            },
        ...
        gsapWithCSS.from(".footer__link-banner", {
            scrollTrigger: {
                trigger: ".footer",
                start: "-100 center"
            },
